...
- [Bluesky](https://bsky.app/profile/snarky.ca) (with 561 followers)
...
<li>🏃 <a href="https://peps.python.org/4">PEP 4</a> (with Martin von Löwis): Deprecation of Standard Modules</li>

<li>🏃 <a href="https://peps.python.org/2">PEP 2</a> (with Martijn Faassen): Procedure for Adding New Modules</li>

<li>🏃 <a href="https://peps.python.org/11">PEP 11</a> (with Martin von Löwis): CPython platform support</li>

<li>🏃 <a href="https://peps.python.org/12">PEP 12</a> (with David Goodger, Barry Warsaw): Sample reStructuredText PEP Template</li>

<li>✅ <a href="https://peps.python.org/3100">PEP 3100</a>: Miscellaneous Python 3.0 Plans</li>

<li>🤦 <a href="https://peps.python.org/339">PEP 339</a>: Design of the CPython Compiler</li>

<li>❌ <a href="https://peps.python.org/348">PEP 348</a>: Exception Reorganization for Python 3.0</li>

<li>✅ <a href="https://peps.python.org/352">PEP 352</a> (with Guido van Rossum): Required Superclass for Exceptions</li>

<li>✅ <a href="https://peps.python.org/360">PEP 360</a>: Externally Maintained Packages</li>

<li>✅ <a href="https://peps.python.org/362">PEP 362</a> (with Jiwon Seo, Yury Selivanov, Larry Hastings): Function Signature Object</li>

<li>✅ <a href="https://peps.python.org/3108">PEP 3108</a>: Standard Library Reorganization</li>

<li>✅ <a href="https://peps.python.org/3113">PEP 3113</a>: Removal of Tuple Parameter Unpacking</li>

<li>❌ <a href="https://peps.python.org/3122">PEP 3122</a>: Delineation of the main module</li>

<li>✅ <a href="https://peps.python.org/374">PEP 374</a> (with Stephen J. Turnbull, Alexandre Vassalotti, Barry Warsaw, Dirkjan Ochtman): Choosing a distributed VCS for the Python project</li>

<li>❌ <a href="https://peps.python.org/401">PEP 401</a> (with Barry Warsaw): BDFL Retirement</li>

<li>✅ <a href="https://peps.python.org/3003">PEP 3003</a> (with Jesse Noller, Guido van Rossum): Python Language Moratorium</li>

<li>✅ <a href="https://peps.python.org/399">PEP 399</a>: Pure Python/C Accelerator Module Compatibility Requirements</li>

<li>✅ <a href="https://peps.python.org/512">PEP 512</a>: Migrating from hg.python.org to GitHub</li>

<li>✅ <a href="https://peps.python.org/488">PEP 488</a>: Elimination of PYO files</li>

<li>✅ <a href="https://peps.python.org/518">PEP 518</a> (with Nathaniel J. Smith, Donald Stufft): Specifying Minimum Build System Requirements for Python Projects</li>

<li>✅ <a href="https://peps.python.org/519">PEP 519</a> (with Koos Zevenhoven): Adding a file system path protocol</li>

<li>✅ <a href="https://peps.python.org/523">PEP 523</a> (with Dino Viehland): Adding a frame evaluation API to CPython</li>

<li>✅ <a href="https://peps.python.org/8001">PEP 8001</a> (with Christian Heimes, Donald Stufft, Eric Snow, Gregory P. Smith, Łukasz Langa, Mariatta, Nathaniel J. Smith, Pablo Galindo Salgado, Raymond Hettinger, Tal Einat, Tim Peters, Zachary Ware): Python Governance Voting Process</li>

<li>✅ <a href="https://peps.python.org/594">PEP 594</a> (with Christian Heimes): Removing dead batteries from the standard library</li>

<li>✅ <a href="https://peps.python.org/621">PEP 621</a> (with Dustin Ingram, Paul Ganssle, Pradyun Gedam, Sébastien Eustace, Thomas Kluyver, Tzu-ping Chung): Storing project metadata in pyproject.toml</li>

<li>🤦 <a href="https://peps.python.org/650">PEP 650</a> (with Vikram Jayanthi, Dustin Ingram): Specifying Installer Requirements for Python Projects</li>

<li>❌ <a href="https://peps.python.org/641">PEP 641</a> (with Steve Dower, Barry Warsaw): Using an underscore in the version portion of Python 3.10 compatibility tags</li>

<li>❌ <a href="https://peps.python.org/665">PEP 665</a> (with Pradyun Gedam, Tzu-ping Chung): A file format to list Python dependencies for reproducibility of an application</li>

<li>👍 <a href="https://peps.python.org/685">PEP 685</a>: Comparison of extra names for optional distribution dependencies</li>

<li>✍ <a href="https://peps.python.org/751">PEP 751</a>: A file format to record Python dependencies for installation reproducibility</li>

<li>✍ <a href="https://peps.python.org/758">PEP 758</a> (with Pablo Galindo): Allow ``except`` and ``except*`` expressions without parentheses</li>

<li>🤦 <a href="https://peps.python.org/760">PEP 760</a> (with Pablo Galindo): No More Bare Excepts</li>
